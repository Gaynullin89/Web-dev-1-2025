...
// === Словарь категорий (соответствие API и наших слотов) ===
const categoryMap = {
  "main-course": "main",
  salad: "starter",
  soup: "soup",
...
if (orderForm) {
  orderForm.addEventListener("submit", async (e) => {
    e.preventDefault(); // ❗️отключаем перезагрузку страницы
    ...
    try {
      ...
      localStorage.removeItem("comboOrder"); // ✅ очищаем только после успеха
    } catch (err) {
